 ...
 * This code has been modified. Portions copyright (C) 2014, Merkmod Project.
...
public class KattaGangActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setImageResource(com.android.internal.R.drawable.katta_logo);
        ...
        tv.setText("MERKMOD " + Build.VERSION.RELEASE);
        ...
        logo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                try {
                    ...
                    android.util.Log.e("KattaGangActivity", "Couldn't catch a break.");
                }
                finish();
                return true;
            }
